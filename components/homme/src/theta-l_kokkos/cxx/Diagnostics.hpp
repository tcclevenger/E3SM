...
private:
  ...
  HostViewUnmanaged<F90Real*[NUM_DIAG_TIMES][NP][NP]> h_IEner;
  HostViewUnmanaged<F90Real*[NUM_DIAG_TIMES][NP][NP]> h_KEner;
  HostViewUnmanaged<F90Real*[NUM_DIAG_TIMES][NP][NP]> h_PEner;
  ...
  HostViewUnmanaged<F90Real*[NUM_DIAG_TIMES][QSIZE_D][NP][NP]> h_Qvar;
  HostViewUnmanaged<F90Real*[NUM_DIAG_TIMES][QSIZE_D][NP][NP]> h_Qmass;
  HostViewUnmanaged<F90Real*                [QSIZE_D][NP][NP]> h_Q1mass;
