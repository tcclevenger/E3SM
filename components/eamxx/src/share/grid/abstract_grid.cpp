...
AbstractGrid::create_equivalent_layout (const FieldLayout& template_layout) const
{
  ...
  switch (template_layout.type()) {
    ...
    case LayoutType::Vector2D:
      ret_layout = get_2d_vector_layout(template_layout.get_vector_dim(), template_layout.get_dim_names()[0]);
      break;
    ...
    case LayoutType::Vector3D:
      ret_layout = get_3d_vector_layout(midpoints, template_layout.get_vector_dim(), template_layout.get_dim_names()[0]);
      break;
